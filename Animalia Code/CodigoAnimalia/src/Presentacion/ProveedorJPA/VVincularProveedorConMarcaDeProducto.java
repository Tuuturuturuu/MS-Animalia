...
public class VVincularProveedorConMarcaDeProducto extends JFrame implements IGUI {
	public VVincularProveedorConMarcaDeProducto() {
	...
	private void initGUI() {
	    ...
	    JLabel msgIntroIDCabecera = ComponentsBuilder.createLabel(
	            "Introduzca los datos del proveedor y de la marca de producto que desea vincular ",
	    ...
	    JLabel labelID = new JLabel("ID del Proveedor:");
	    ...
	    botonAceptar.addActionListener(new ActionListener() {
	        ...
	        public void actionPerformed(ActionEvent e) {
	        	VVincularProveedorConMarcaDeProducto.this.setVisible(false);
	        	try {
	                int proveedorID = Integer.parseInt(textID.getText());
	                int marcaID = Integer.parseInt(textMarcaID.getText());
	                ApplicationController.getInstance().manageRequest(new Context(Evento.VINCULAR_PROVEEDOR_A_MARCA, new TProveedorConMarcas(proveedorID, marcaID)));
	            } catch (Exception ex) {
	...
	public void actualizar(Context res) {
		if (res.getEvento() == Evento.VINCULAR_PROVEEDOR_A_MARCA_OK) {			
			ApplicationController.getInstance().manageRequest(new Context (Evento.V_CORRECTO, (int) res.getDatos()));
		} else if (res.getEvento() == Evento.VINCULAR_PROVEEDOR_A_MARCA_KO) {
