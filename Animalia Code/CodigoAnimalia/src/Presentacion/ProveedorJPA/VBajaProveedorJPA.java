...
public class VBajaProveedorJPA extends JFrame implements IGUI {
	public VBajaProveedorJPA() {
	...
	private void initGUI() {
	    ...
	    JLabel msgIntroIDCabecera = ComponentsBuilder.createLabel(
	            "Introduzca el ID del proveedor que desea dar de baja",
	    ...
	    // BOTON ACEPTAR (PROCESAR LA BAJA DEL PROVEEDOR)
	    ...
	    botonAceptar.addActionListener(new ActionListener() {
	        ...
	        public void actionPerformed(ActionEvent e) {
	            try {
	                ...
	                VBajaProveedorJPA.this.setVisible(false);
	                ApplicationController.getInstance().manageRequest(new Context(Evento.BAJA_PROVEEDOR, 
