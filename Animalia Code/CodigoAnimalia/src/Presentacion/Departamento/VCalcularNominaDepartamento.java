...
public class VCalcularNominaDepartamento extends JFrame implements IGUI {
	public VCalcularNominaDepartamento() {
		super("Calcular Nomina Departamento");
	...
	private void initGUI() {
	    ...
	    JLabel msgIntroIDCabecera = ComponentsBuilder.createLabel(
	            "Introduzca el ID del departamento que desea calcular la nomina",
	    ...
	    // BOTON ACEPTAR (PROCESAR EL CALCULO DE NOMINA)
	    ...
	    botonAceptar.addActionListener(new ActionListener() {
	        ...
	        public void actionPerformed(ActionEvent e) {
	            try {
	                ...
	                VCalcularNominaDepartamento.this.setVisible(false);
	                ApplicationController.getInstance().manageRequest(new Context(Evento.CALCULAR_NOMINA_DEPARTAMENTO, 
	...
	public void actualizar(Context res) {
        ...
        Integer resultado = resultadoDouble.intValue(); // Convert Double to Integer
				if (res.getEvento() == Evento.CALCULAR_NOMINA_DEPARTAMENTO_OK) {
					ApplicationController.getInstance().manageRequest(new Context (Evento.V_CORRECT_RESULTADO, resultadoDouble));
				} else if (res.getEvento() == Evento.CALCULAR_NOMINA_DEPARTAMENTO_KO) {
