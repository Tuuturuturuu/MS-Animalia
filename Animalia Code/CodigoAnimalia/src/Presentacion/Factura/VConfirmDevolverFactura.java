...
public class VConfirmDevolverFactura  extends JFrame implements IGUI{

	public VConfirmDevolverFactura() {
	...
	public void initGUI() {
		...
		JLabel labelID = ComponentsBuilder.createLabel("Devolución de Factura realizada correctamente", 10, 100, 80, 20, Color.BLACK);
		mensaje.add(labelID);
		...
		confirmar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				VConfirmDevolverFactura.this.setVisible(false);
