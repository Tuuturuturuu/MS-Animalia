...
public class VDesvincularEmpleadoHabitat extends JFrame implements IGUI {
	...
	public VDesvincularEmpleadoHabitat() {
		super("Desvincular Empleado a Habitat");
	...
	private void initGUI() {
	    ...
	    JLabel msgIntroIDCabecera = ComponentsBuilder.createLabel(
	            "Introduzca los datos del habitat y del empleado que desea desvincular ",
	    ...
	    botonAceptar.addActionListener(new ActionListener() {
	        ...
	        public void actionPerformed(ActionEvent e) {
                VDesvincularEmpleadoHabitat.this.setVisible(false);
	        	try {
	                int habitatID = Integer.parseInt(textHabitatID.getText());
	                int empleadoID = Integer.parseInt(textEmpleadoID.getText());
	             
	                ApplicationController.getInstance().manageRequest(new Context(Evento.DESVINCULAR_EMPLEADO_DE_HABITAT, new TTrabajo(habitatID, empleadoID)));
	            } catch (Exception ex) {
	...
	public void actualizar(Context res) {
		if (res.getEvento() == Evento.DESVINCULAR_EMPLEADO_DE_HABITAT_OK) {			
			ApplicationController.getInstance().manageRequest(new Context (Evento.V_CORRECTO, (int) res.getDatos()));
		} else if (res.getEvento() == Evento.DESVINCULAR_EMPLEADO_DE_HABITAT_KO) {
