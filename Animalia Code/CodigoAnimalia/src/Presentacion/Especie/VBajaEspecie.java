...
public class VBajaEspecie extends JFrame implements IGUI {
	...
	private void initGUI() {
	    ...
	    JLabel msgIntroIDCabecera = ComponentsBuilder.createLabel(
	            "Introduzca el ID de la especie que desea dar de baja",
	    ...
	    // Campo para introducir el ID de la especie
	    JLabel labelID = new JLabel("ID de la Especie:");
	    ...
	    botonAceptar.addActionListener(new ActionListener() {
	        ...
	        public void actionPerformed(ActionEvent e) {
	            try {
	                ...
	                VBajaEspecie.this.setVisible(false);
	                ApplicationController.getInstance().manageRequest(new Context(Evento.BAJA_ESPECIE, 
