...
public class VBajaPase extends JFrame implements IGUI {
	...
	private void initGUI() {
	    ...
	    JLabel msgIntroIDCabecera = ComponentsBuilder.createLabel(
	            "Introduzca el ID del Pase que desea dar de baja",
	    ...
	    // Campo para introducir el ID del Pase
	    JLabel labelID = new JLabel("ID de la Pase:");
	    ...
	    botonAceptar.addActionListener(new ActionListener() {
	        ...
	        public void actionPerformed(ActionEvent e) {
	            try {
	                ...
	                VBajaPase.this.setVisible(false);
	                ApplicationController.getInstance().manageRequest(new Context(Evento.BAJA_PASE, 
