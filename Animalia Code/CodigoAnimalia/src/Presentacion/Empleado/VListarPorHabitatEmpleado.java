...
public class VListarPorHabitatEmpleado extends JFrame implements IGUI {
	
	public VListarPorHabitatEmpleado() {
		super("Mostrar todos los Empleados para dicho Habitat");
	...
	private void initGUI() {
		...
		JLabel msgIntroIDCabecera = ComponentsBuilder.createLabel(
				"Introduzca el ID del habitat que desea consultar sus empleados", 1, 10, 80, 20, Color.BLACK);
		...
		botonAceptar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				VListarPorHabitatEmpleado.this.setVisible(false);
					try {
						Integer id_Habitat = Integer.parseInt(id.getText());
						//Vamos a tratar el error de campos nulos
		            	ApplicationController.getInstance().manageRequest(new Context(Evento.LISTAR_EMPLEADOS_POR_HABITAT, 
