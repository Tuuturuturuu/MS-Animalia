...
public class VMostrarEmpleadoPorId extends JFrame implements IGUI {

	private Set<TEmpleado> listaEmpleados;
	
	public VMostrarEmpleadoPorId (Set<TEmpleado> Empleados) {
	...
	private void initGUI() {
		...
		botonCancelar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				VMostrarEmpleadoPorId.this.setVisible(false);
	...
	public void actualizar(Context res) {
		if (res.getDatos() != null) {
			this.listaEmpleados = (Set<TEmpleado>) res.getDatos();
			initGUI();
		}	
